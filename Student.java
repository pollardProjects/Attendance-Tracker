...
public class Student {
  ...
  //ADDED COURSE INFORMATION BETWEEN GENDER AND TOTAL
    //for console printing purposes
    public String toString() {
        return "First Name: " + getFirstName() + " | Last Name: " + getLastName() + " | Year: " + getYear() +
                " | Age: " + getAge() + " | GPA: " + getGradepoint() + " | Gender: " + getGender() +
                " | Course: " + getCourse() + " | Total Days: " + getTotal();
    }
